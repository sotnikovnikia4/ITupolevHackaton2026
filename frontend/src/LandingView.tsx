  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center pointer-events-none">
        <span className="mt-3 mb-4 text-sm font-bold tracking-[0.25em] text-black uppercase md:text-base">
          Itupolev
        </span>
        ...
        <p className="mt-6 text-xs font-semibold uppercase tracking-widest text-black/100 animate-pulse">
